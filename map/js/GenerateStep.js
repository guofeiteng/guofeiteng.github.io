...
//set three maps while get into the step free version of the application.
var StepFEntrance;
StepFEntranceOverlay.prototype = new google.maps.OverlayView();
var ATM;
...
///////////////////////////////////////////////////
//Set stepfreeEntrances overlay
function StepFEntranceOverlay()
{
  this.div_ = null;
  this.setMap(map);
}
...
function drawStepMap(data)
{
  StepFEntranceOverlay.prototype.onAdd = function() 
  {
    
  //select the style of stepfree, whcih draw circle as color blue.
   layer = d3.select(this.getPanes().overlayLayer).append("div").attr("class", "Step");
    

  };

    // Draw markers as SVG elements on overlays.
  StepFEntranceOverlay.prototype.draw = function() 
  {
